          ...
          <div className="bg-white h-fit rounded">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2">
              <section className="p-4">
                ...
                <p>28 Years</p>
                <p className="font-semibold text-sm mt-3 text-slate-500">
                  Selery
                </p>
                <p>30k</p>
              </section>
          ...
          <div className="bg-white mt-6 p-4 rounded">
            ...
            <section className="flex gap-6 md:gap-16 mb-3">
              <img
                ...
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7gbuAdC1XjNyht9ygDYU5jdmgj6xfvIgeLRL-Zl0&s"
                alt=""
              />
              <span>
